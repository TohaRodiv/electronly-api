...
domains=("api.electronly.ru")
email="toha.rodiv@yandex.ru" # Adding a valid address is strongly recommended
...
docker-compose up -d server && docker-compose restart server
